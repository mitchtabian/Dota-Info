package com.codingwithmitch.dotainfo.hero_datasource.cache.model

import com.codingwithmitch.dotainfo.hero_domain.*
import com.codingwithmitch.dotainfo.herodatasource.cache.Hero_Entity
...
fun Hero_Entity.toHero(): Hero {
    return Hero(
        ...
        img = img,
        icon = icon,
        baseHealth = baseHealth.toLong(),
        baseHealthRegen = baseHealthRegen?.toLong(),
        baseMana = baseMana.toLong(),
        baseManaRegen = baseManaRegen?.toLong(),
        baseArmor = baseArmor.toLong(),
        baseMoveRate = baseMoveRate.toLong(),
        ...
        strGain = strGain.toLong(),
        agiGain = agiGain.toLong(),
        intGain = intGain.toLong(),
        attackRange = attackRange.toInt(),
        projectileSpeed = projectileSpeed.toInt(),
        attackRate = attackRate.toLong(),
        moveSpeed = moveSpeed.toInt(),
        turnRate = turnRate?.toLong(),
        legs = legs.toInt(),
